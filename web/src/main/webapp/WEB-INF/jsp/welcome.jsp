...
<body class="bwelcome"  >
 ...
 Services
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
	...
	<div class="typ">
		<h1>
			<p class="typewrite" data-period="2000" style="color: 	#36454F"
		...
		<div class="row gx-5 gy-5">
			...
			<div class="row gx-8 gy-8">
				<div class="p-3 bg-grey">
					...
					<div class="col-12 d-flex mt-2 p-3 text-wrap text-center">
						<h2 style="color:#00FFBF;background-color:#000000">Today's Deal</h2><br><br>
					</div>
					<div class="col-12 d-flex mt-2 p-3 text-wrap text-center">
